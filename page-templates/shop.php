											...
											<div class="filter-items filter-items-count">
                                                <div class="filter-item">
                                                    <div class="custom-control custom-checkbox">
                                                        <input 
                                                            type="checkbox" 
                                                            class="custom-control-input wc-cat-filter" 
                                                            id="cat-all"
                                                            data-cat="all"
                                                            checked
                                                        >
                                                        <label class="custom-control-label" for="cat-all">
                                                            All
                                                        </label>
                                                    </div>
                                                    <span class="item-count">All</span>
                                                </div>
                                                ...
                                                <?php foreach ($categories as $cat): ?>
                                                    ...
                                                    <div class="filter-item">
                                                        <div class="custom-control custom-checkbox">
                                                            ...
                                                            >
                                                            <label class="custom-control-label" for="cat-<?php echo $cat->term_id; ?>">
                                                                <?php echo $cat->name; ?>
                                                            </label>
                                                        </div>
